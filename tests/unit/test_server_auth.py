...
def test_validate_api_key_no_key_configured():
...
def test_validate_api_key_empty_key():
...
def test_proxy_headers_x_auth_request_user():
...
def test_proxy_headers_x_forwarded_user():
...
def test_proxy_headers_no_user():
...
def test_proxy_headers_only_user():
...
@pytest.mark.asyncio
async def test_valid_api_key_returns_api_client():
...
@pytest.mark.asyncio
async def test_proxy_headers_auth():
...
@pytest.mark.asyncio
async def test_api_key_only_no_credentials_raises_401():
...
@pytest.mark.asyncio
async def test_proxy_only_no_headers_raises_401():
...
@pytest.mark.asyncio
async def test_both_auth_methods_no_valid_credentials():
...
@pytest.mark.asyncio
async def test_api_key_takes_precedence_over_proxy():
